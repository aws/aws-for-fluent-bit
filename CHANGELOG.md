...
### 3.5.0
* Minimal set of packages installed using Amazon Linux 2023 container image version: 2023.12.20260918.0
* enhancement: update fluent-bit version to 5.1.2 [#1207](https://github.com/aws/aws-for-fluent-bit/pull/1207)

### 2.34.3.20260918
* Minimal set of packages installed using Amazon Linux 2 container image version: 2.0.20260917.1

### 3.4.18
* Minimal set of packages installed using Amazon Linux 2023 container image version: 2023.12.20260917.1

### 2.34.3.20260915
* Minimal set of packages installed using Amazon Linux 2 container image version: 2.0.20260914.1

### 3.4.17
* Minimal set of packages installed using Amazon Linux 2023 container image version: 2023.12.20260914.0

### 2.34.3.20260910
* Minimal set of packages installed using Amazon Linux 2 container image version: 2.0.20260909.0

### 3.4.16
* Minimal set of packages installed using Amazon Linux 2023 container image version: 2023.12.20260909.0

### 2.34.3.20260901
* Minimal set of packages installed using Amazon Linux 2 container image version: 2.0.20260831.0

### 3.4.15
* Minimal set of packages installed using Amazon Linux 2023 container image version: 2023.12.20260831.0

### 2.34.3.20260826
* Minimal set of packages installed using Amazon Linux 2 container image version: 2.0.20260825.0
...
### 3.4.12
* Minimal set of packages installed using Amazon Linux 2023 container image version: 2023.12.20260727.0
* fix: use merge time for changelog release boundary [#1178](https://github.com/aws/aws-for-fluent-bit/pull/1178)
...
### 3.4.10
* Minimal set of packages installed using Amazon Linux 2023 container image version: 2023.12.20260720.0
...
### 3.4.5
* Minimal set of packages installed using Amazon Linux 2023 container image version: 2023.12.20260622.0
...
### 2.34.3.20260609
* Minimal set of packages installed using Amazon Linux 2 container image version: 2.0.20260608.0

### 3.4.2
* Minimal set of packages installed using Amazon Linux 2023 container image version: 2023.12.20260608.0
...
* Amazon Kinesis Streams for Fluent Bit 1.10.4
* Amazon Kinesis Firehose for Fluent Bit 1.7.3
...
### 3.2.4
* Minimal set of packages installed using Amazon Linux 2023 container image version: 2023.10.20260302.0

### 2.34.3.20260219
* Minimal set of packages installed using Amazon Linux 2 base container image version: 2.0.20260216.0

### 3.2.3
* Minimal set of packages installed using Amazon Linux 2023 container image version: 2023.10.20260216.1
